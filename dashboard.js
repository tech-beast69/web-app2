...
<head>
    ...
    <title>Group Management - Bot Dashboard</title>
    
    <!-- Content Security Policy for Telegram Web App -->
    <meta http-equiv="Content-Security-Policy" content="
        default-src 'self' https://tech-beast69.github.io https://telegram.org; 
        script-src 'self' 'unsafe-inline' 'unsafe-eval' https://telegram.org https://cdnjs.cloudflare.com; 
        style-src 'self' 'unsafe-inline' https://cdnjs.cloudflare.com; 
        connect-src 'self' https://tech-beast69.github.io https://*.glacierhosting.org https://1e4fecb5-5c9e-4fb3-8ace-01c2cc75312b.glacierhosting.org;
...
<body>
    <div class="group-management-container">
        <header>
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <a href="index.html" class="btn-secondary" style="text-decoration: none; padding: 12px 24px; border-radius: 12px; font-weight: 700; display: inline-flex; align-items: center; gap: 8px; transition: all 0.3s ease; background: white; color: #0f172a; border: 2px solid rgba(255, 255, 255, 0.3); box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);">
        ...
        <div id="errorBanner" class="error-banner" style="display: none;">
            <div class="error-content">
                ...
                <button id="retryBtn" class="retry-btn" onclick="retryLoadData()">
                ...
                <div id="federationTab" class="tab-content">
                    <div class="settings-section">
                        ...
                        <div id="federationInfo">
                            <div><strong>Name:</strong> <span id="fedName">—</span></div>
                            <div><strong>ID:</strong> <span id="fedId">—</span></div>
                            <div><strong>Owner:</strong> <span id="fedOwner">—</span></div>
    ...
    <script src="dashboard.js?v=3.1"></script>
</body>
