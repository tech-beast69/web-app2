...
### Added
- New `discord-management.html` page for Discord server moderation management.
- New `discord-management.js` client for protected moderation API calls using Bearer token.
- Dashboard navigation link from `index.html` to Discord management page.
- Config key `DISCORD_ADMIN_TOKEN_STORAGE_KEY` in `config.js`.

### Supports
- Load and update guild moderation config.
- Load moderation cases by guild.
- Load and clear user warnings by guild/user.
